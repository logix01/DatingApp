...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        RoomsDao.createTable(db, ifNotExists);
        RoomsParticipantsDao.createTable(db, ifNotExists);
        UserTrackingDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        RoomsDao.dropTable(db, ifExists);
        RoomsParticipantsDao.dropTable(db, ifExists);
        UserTrackingDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(RoomsParticipantsDao.class);
        registerDaoClass(UserTrackingDao.class);
    }
